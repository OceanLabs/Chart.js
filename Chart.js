			...
			draw : function(){
				if (this.display){
					...
					if (this.hoverEvent) {
						...
						ctx.closePath();
						ctx.strokeStyle = this.fillColor; //"#4b97af";
						ctx.fillStyle = "#fff";
						ctx.fill();
						ctx.stroke();
					}
		...
		Chart.Tooltip = Chart.Element.extend({
			draw : function(){
				...
				if (!this.verticalToolTip) {
					...
					var tooltipY = this.y - tooltipRectHeight/2; //- tooltipHeight/2;
				}
				...
				if (this.options.showTooltips){
					helpers.bindEvents(this, this.options.tooltipEvents, function(evt){
						...
						this.eachPoints(function(point){
							point.restore(['fillColor', 'strokeColor', 'hoverEvent']);
						});
	
						helpers.each(activePoints, function(activePoint){
							activePoint.fillColor =  activePoint.highlightFill;
							activePoint.strokeColor = '#fff'//activePoint.highlightStroke;
							activePoint.hoverEvent = true;
						});
				...
				helpers.each(data.datasets,function(dataset){
					...
					helpers.each(dataset.data,function(dataPoint,index){
						...
						datasetObject.points.push(new this.PointClass({
							...
							highlightFill : dataset.pointColor,
